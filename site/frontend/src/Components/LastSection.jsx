...
const LastSection = () => {
  return (
    <Box sx={{ width: '100%', display: 'flex', flexDirection: 'row', marginTop: 10 }}>
      <Box sx={{ flex: 1, justifyContent: 'center', alignItems: 'center', height: '100%', backgroundColor: purple[600], paddingY: 7 }}>
        <Link to='/aboutus' style={{ textDecoration: 'none', color: 'inherit' }}>
          ...
          <Typography sx={{ textAlign: 'center', color: 'white', fontSize: 28, transition: '0.3s ease-in-out', ':hover': { color: 'grey' } }}>Vision & Goals</Typography>
        </Link>
      </Box>
      ...
      <Box sx={{ flex: 1, alignItems: 'center', justifyContent: 'center', height: '100%', backgroundColor: blueGrey[500], paddingY: 7 }}>
        <Link to='/ourprograms' style={{ textDecoration: 'none', color: 'inherit' }}>
          ...
          <Typography sx={{ textAlign: 'center', color: 'white', fontSize: 28, transition: '0.3s ease-in-out', ':hover': { color: 'grey' } }}>Projects In Ghana</Typography>
        </Link>
      </Box>
      ...
      <Box sx={{ flex: 1, alignItems: 'center', justifyContent: 'center', height: '100%', backgroundColor: blue[700], paddingY: 7 }}>
        <Link to='/donate' style={{ textDecoration: 'none', color: 'inherit' }}>
          ...
          <Typography sx={{ textAlign: 'center', color: 'white', fontSize: 28, transition: '0.3s ease-in-out', ':hover': { color: 'grey' } }}>Volunteer Or Donate</Typography>
        </Link>
      </Box>
    </Box>
  );
